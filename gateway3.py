...
{re}     {ly}//----------{y}BloodHub WorldPay Gate3{ly}-------------//{re}
{re}    {ly}//---------------{y}Python Based v3{ly}---------------//{re}
...
{re}  {ly}================================================ {re}
    ...
    def check_on_sage(self, credit_card, ccentry):
        ...
        persrespans = BeautifulSoup(session.post('https://www.rowanshospice.co.uk/donate/make-a-donation/', data=FirstData, headers=headers).text, 'html.parser')
